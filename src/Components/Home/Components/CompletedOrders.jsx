...
export default function CompletedOrders() {
    ...
    const [workerPhoneFilter, setWorkerPhoneFilter] = useState("");
    ...
    const getFilteredOrders = async () => {
        ...
        try {
            ...
            if (workerPhoneFilter.trim()) {
                params.workerPhoneNumber = workerPhoneFilter.trim();
            }
                ...
                <Card className="mt-4 p-6 shadow-lg border border-gray-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <Input
                                type="text"
                                placeholder="Ishchi telefon raqami"
                                value={workerPhoneFilter}
                                onChange={(e) => setWorkerPhoneFilter(e.target.value)}
                                className="!border-gray-300 focus:!border-MainColor"
                                labelProps={{
                                    className: "before:content-none after:content-none",
                                }}
                        ...
                        >
                            ...
                            <div className="flex items-center gap-[30px]">
                                <div className="flex items-center gap-[10px]">
                                    ...
                                    <span className="block px-[20px] text-[15px] py-[2px] bg-green-500 rounded-[8px] text-white font-medium">
                                        {item?.id}
                                    </span>
                                </div>
                                <div className="flex items-center gap-[10px]">
                            ...
                            <div className="flex items-center gap-[30px] mt-[10px]">
                                <div className="flex items-center gap-[10px]">
                                    <span className="font-semibold text-gray-600">Ishchi:</span>
                                    <span className="font-medium text-gray-800">
                                        {item?.worker?.fullName}
                                    </span>
                                </div>
                                <div className="flex items-center gap-[10px]">
                                    <span className="font-semibold text-gray-600">Ishchi telefoni:</span>
                                    <span className="font-medium text-gray-800">
                                        {item?.worker?.phoneNumber}
                                    </span>
                                </div>
                            </div>
                            <div className="flex items-start gap-[20px] mt-[15px]">
                                ...
                                <div className="w-auto">
                                    <NavLink to={`/ns/order/${item?.id}`} state={{ item }}>
                                        <button className="w-[140px] hover:bg-transparent text-white hover:text-green-500 border-[2px] border-green-500 duration-300 bg-green-500 px-[10px] py-[8px] rounded-[6px] block font-medium shadow-md hover:shadow-lg">
                                            Batafsil
                                        </button>
                                    </NavLink>
                                </div>
                            ...
                            <div className="flex items-center justify-between mt-[20px]">
                                <div className="flex items-center gap-[10px]">
                                    <span className="block px-[5px] text-[25px] py-[2px] bg-green-500 rounded-[8px] text-white">
